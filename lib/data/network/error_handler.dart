...
class ResoponseCode{
  ...
  static const int FORBIDDEN = 403; // failure, user API rejected request
...
class ResoponseMessage{
  ...
  static const String FORBIDDEN = "Forbidden request, Try again later"; // failure, user API rejected request
